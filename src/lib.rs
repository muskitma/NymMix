...
#[derive(Debug)]
pub struct NymMixProcessor {
    verbose: bool,
    processed_count: usize,
}

impl NymMixProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting NymMix processing");
    
    let mut processor = NymMixProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = NymMixProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = NymMixProcessor::new(false);
